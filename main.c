...
/*   Updated: 2019/04/05 13:45:58 by sid-bell         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv, char **env)
{
	...
	//t_list *history = params.history;
	//while((line = read_setup(history)))
	{
		if (text)
		{
